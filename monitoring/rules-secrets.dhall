...
let unmanagedSecrets =
      [ "cloud_softwarefactory_service_account_token"
      , "tenant_builds_zuul_api_url_es_password"
      , "tenant_builds_zuul_api_url_es_password"
      , "internal_users_admin_password"
      , "internal_users_kibanaserver_password"
      , "users_admin_password"
      , "users_logstash_password"
      , "users_curator_password"
      , "users_zuul_password"
      , "users_admin_password"
      , "users_logstash_password"
      , "users_curator_password"
      ...
      , "database_secret_key"
      , "secret_key"
      , "quay_users_admin_password"
      , "quay_users_admin_token"
      , "quay_users_sf_password"
      , "quay_users_tripleo_password"
      , "quay_users_tripleo_token"
      , "quay_users_zuul_password"
      , "quay_organizations_tripleo_tripleomastercentos9_token"
      , "quay_organizations_tripleo_tripleowallabycentos9_token"
      , "quay_organizations_tripleo_tripleozedcentos9_token"
      , "quay_organizations_tripleo_openstack-k8s-operators_token"
      , "quay_organizations_tripleo_podified-main-centos9_token"
      , "quay_organizations_tripleo_podified-master-centos9_token"
      , "quay_organizations_tripleo_podified-zed-centos9_token"
      , "quay_organizations_tripleo_podified-antelope-centos9_token"
      , "quay_organizations_tripleo_podified-master-centos10_token"
      , "install_server_sf_key"
      , "install_server_rdo_key"
      , "rhel_activationkey"
      , "rhel_org_id"
      , "rhel_pool_ids"
      , "loki_auth_config_gateway_password"
      , "sf_grafana_password"
      , "vexxhost_nodepool_sf_password"
      , "vexxhost_nodepool_tripleo_password"
      , "vexxhost_ansible_project"
      , "vexxhost_ansible_username"
      , "vexxhost_ansible_password"
      , "vexxhost_prometheus_password"
      , "vexxhost_prometheus_url"
      , "vexxhost_prometheus_user"
      , "nextgen_openshift_prometheus_url"
      , "vexxhost_ceph_s3_access"
      , "vexxhost_ceph_s3_secret"
      , "gateway_password"
      , "vexxhost_nodepool_rdo_password"
...
in  Secret.renderSecretAlerts
      (   [ Secret::{
        ...
        # Prelude.List.map Text Secret.Type mkUnknownSecret unmanagedSecrets
      )
